...
public class Verify {
     ...
     * @param object the object to check
     * @param exception the exception to be thrown if the assertion fails
     * @throws the required exception if the object is not {@code null}
     */
     ...
     * @throws IllegalArgumentException if the object array contains a {@code null} element
     */
    public static void noNullElements(Set<? extends Object> set, String message) {
        if (set != null) {
     ...
     * @throws the required exception if the object array contains a {@code null} element
     */
    public static void noNullElements(Set<? extends Object> set, RuntimeException exception) {
        if (set != null) {
            for (Object element : set) {
                if (element == null) {
                    throw exception;
    ...
    /**
     * Verify that a list has no null elements. Note: Does not complain if the list is empty!
     * 
     * @param list the list to check
     * @param message the exception message to use if the assertion fails
     * @throws IllegalArgumentException if the object list contains a {@code null} element
     */
    public static void noNullElements(List<? extends Object> list, String message) {
        if (list != null) {
     ...
     * @param list the list to check
     * @param exception the exception to be thrown if the assertion fails
     * @throws the required exception if the object list contains a {@code null} element
     */
    public static void noNullElements(List<? extends Object> list, RuntimeException exception) {
        if (list != null) {
            for (Object element : list) {
                if (element == null) {
     ...
     * @throws IllegalArgumentException if the object array contains a {@code null} element
     */
    public static void noNullElements(Set<? extends Object> set) {
        noNullElements(set, "[failed] - this set must not contain any null elements");
    }
     ...
     * @throws IllegalArgumentException if the object list contains a {@code null} element
     */
    public static void noNullElements(List<? extends Object> items) {
        noNullElements(items, "[failed] - this list must not contain any null elements");
    }
