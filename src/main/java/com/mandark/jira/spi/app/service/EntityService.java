...
public interface EntityService<K, E extends IEntity<K>, ED extends EntityDTO<E>> {
    ...
    /**
     * Read an entity object by it's unique ID. If a object is not found with the passed ID, a
     * {@link RuntimeException} will be thrown.
     * 
     * @param id Unique ID of the entity object.
     * @param errorIfNotFound if set to true, a {@link RuntimeException} will be thrown if no object
